...
class Creatprofilepatien extends StatefulWidget {
  ...
  const Creatprofilepatien(
      {Key? key, required this.name, required this.email, required this.pass})
      : super(key: key);
                              ...
                              if(myImage == ""){
                                ...
                                if (_formKey.currentState!.validate()) {
                                  dynamic result = await _auth.registerWithEmailAndPassword(
                                      widget.name,
                                      widget.email, widget.pass,"patint",age,address,phone,_gender.toString().split('.').last,_isClinc.toString().split('.').last,"",myImage,"",myWidth,myheight,diseases,"true","");
                                  if (result == null) {
                                    setState(() {
