...
class ProfileNutritionist extends StatefulWidget {
  const ProfileNutritionist(
      ...
      required this.spizlezedGender, required this.spizlezedCv,required this.spizlezedPhone,required this.cansearsh,required this.myCover,required this.isClinc,})
      : super(key: key);
